...
.. image:: /images/vixo-creating-a-site-menu.png
   :scale: 100 %
   :alt: Vixo creating a site menu
...
.. image:: /images/vixo-creating-a-page-dialog-box.png
   :scale: 100 %
   :alt: Vixo creating a page dialog box
...
.. image:: /images/vixo-bug-tracker-static-data-page.png
   :scale: 100 %
   :alt: Vixo bug tracker static data page

A number of features have been highlighted as they involve the use of some special vixo functions:
...
2. In the lower section we see a number of links created using the special vixo navigation function ``=LINK``. As an example cell ``B22`` has the function which will be incorporated in to the application’s navigation menu
...
.. image:: /images/vixo-bug-tracker-static-data-webpage.png
   :scale: 100 %
   :alt: Vixo bug tracker static data webpage view
