# -*- coding: utf-8 -*-
#
# Building Applications With Vixo documentation build configuration file, created by
...
copyright = u'2012, Hypernumbers Ltd (trading as vixo.com)'
...
htmlhelp_basename = 'BuildingApplicationsWithVixodoc'
